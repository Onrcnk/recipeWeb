package com.onrcnk.spring5recipeapp.bootstrap;


import com.onrcnk.spring5recipeapp.domain.*;
import com.onrcnk.spring5recipeapp.repositories.CategoryRepository;
import com.onrcnk.spring5recipeapp.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void saveCategories(){
        Category c1 = new Category("American");
        Category c2 = new Category("Italian");
        Category c3 = new Category("Mexican");
        Category c4 = new Category("Fast Food");
    ...
    private void saveUOM(){
        UnitOfMeasure u1 = new UnitOfMeasure("Teaspoon");
        UnitOfMeasure u2 = new UnitOfMeasure("Tablespoon");
        UnitOfMeasure u3 = new UnitOfMeasure("Cup");
        UnitOfMeasure u4 = new UnitOfMeasure("Pinch");
        UnitOfMeasure u5 = new UnitOfMeasure("Ounce");
        UnitOfMeasure u6 = new UnitOfMeasure("Each");
        UnitOfMeasure u7 = new UnitOfMeasure("Dash");
        UnitOfMeasure u8 = new UnitOfMeasure("Pint");

        unitOfMeasureRepository.save(u1);
        unitOfMeasureRepository.save(u2);
        unitOfMeasureRepository.save(u3);
        unitOfMeasureRepository.save(u4);
        unitOfMeasureRepository.save(u5);
        unitOfMeasureRepository.save(u6);
        unitOfMeasureRepository.save(u7);
        unitOfMeasureRepository.save(u8);
    }
